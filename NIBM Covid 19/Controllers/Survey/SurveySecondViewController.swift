//
//  SurveySecondViewController.swift
//  NIBM Covid19
//
...
class SurveySecondViewController: UIViewController {
    ...
    let symptomsImageView: UIImageView = {
        let imageView = UIImageView(image: #imageLiteral(resourceName: "travel") )
    ...
    let questionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string:  "Have you been travelling in between last 14 days?", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 22)])
