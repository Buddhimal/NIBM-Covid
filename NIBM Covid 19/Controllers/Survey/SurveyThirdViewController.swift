//
//  SurveyThirdViewController.swift
//  NIBM Covid19
//
...
class SurveyThirdViewController: UIViewController {
    ...
    let symptomsImageView: UIImageView = {
        let imageView = UIImageView(image: #imageLiteral(resourceName: "crowd") )
    ...
    let questionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string:  "Have you been exposed with crowded places?", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 22)])
